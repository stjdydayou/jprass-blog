...
<html lang="en">
    <head>
        ...
        <title>添加文章-<{jprass_config name="blog.title"}>-Powered by Joyphper</title>
				...
				<table cellspacing="0" align="center" width="960">
					<tr>
						...
						<td width="230" valign="top">
							...
							<input type="text" name="_year" id="year" maxlength="4" style="width:35px" value="<{$smarty.now|date_format:'%Y'}>" />
							<span>-</span>
							<input type="text" name="_month" id="month" maxlength="2" style="width:20px" value="<{$smarty.now|date_format:'%m'}>" />
							<span>-</span>
							<input type="text" name="_day" id="day" maxlength="2" style="width:20px" value="<{$smarty.now|date_format:'%d'}>" />
							<span>@</span>
							<input type="text" name="_hour" id="hour" maxlength="2" style="width:20px" value="<{$smarty.now|date_format:'%H'}>" />
							<span>:</span>
							<input type="text" name="_min" id="min" maxlength="2" style="width:20px" value="<{$smarty.now|date_format:'%M'}>" />
							...
							<div class="select-cate">
								...
								<label><input type="checkbox" name="cid[]" value="<{$cate.id}>" <{if $i eq 0}>checked<{/if}> /><{$cate.catename}></label>
								<{/foreach}>
							</div>
						</td>
					</tr>
